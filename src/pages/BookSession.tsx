...
const categoriesList = [
  {
    ...
    name: "Core Support",
    icon: "🧠",
    desc: "Individual counselling, trauma healing, and core emotional support.",
  },
  {
    id: "relationships",
    name: "Relationships",
    icon: "💑",
    desc: "Relationship counselling, dating support, and couples therapy.",
  },
  {
    id: "growth",
    name: "Growth & Coaching",
    icon: "🌱",
    desc: "Self-esteem, career transitions, and life coaching.",
  },
  {
    id: "identity",
    name: "Identity & Inclusion",
    icon: "🏳️‍🌈",
    desc: "LGBTQ+ affirmative counselling and identity support.",
  },
  {
    id: "specialist",
    name: "Specialist Programs",
    icon: "🎓",
    desc: "Student support, group therapy, and corporate wellness.",
  },
];
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {categoriesList.map((s) => (
                ...
                >
                  ...
                  <h3 className="font-syne font-bold text-taawa-text text-[0.95rem] mb-1">
                    {s.name}
                  </h3>
                  <p className="font-instrument text-taawa-muted text-[0.82rem] leading-relaxed">
                    {s.desc}
                  </p>
                </button>
              ))}
              ...
              {allServices
                ...
                .map((s) => (
                  ...
                  >
                    ...
                    <p className="font-instrument text-taawa-muted text-[0.82rem] leading-relaxed line-clamp-2">
                      {s.tagline}
                    </p>
                  </button>
                ))}
          ...
          {step === 3 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-card p-6 border border-taawa-green/15 shadow-sm">
                <h3 className="font-syne font-bold text-taawa-text text-[0.95rem] mb-4">
                  Select a Date
                </h3>
            ...
            <div className="bg-white rounded-card p-8 max-w-lg mx-auto border border-taawa-sage/25 shadow-md">
              <div className="space-y-4">
                <div>
                  ...
                  />
                  {errors.fullName && (
                    <p className="text-taawa-salmon text-[0.75rem] mt-1 pl-5">
                      {errors.fullName}
                    </p>
                  )}
                </div>
                ...
                <div className="bg-taawa-bg2 rounded-card p-5 mt-2 border border-taawa-green/15">
                  <h4 className="font-syne font-bold text-taawa-text text-[0.85rem] mb-3">
                    Booking Summary
                  </h4>

                  <div className="space-y-1.5 font-instrument text-[0.82rem]">
                    <p>
                      <span className="text-taawa-muted">Service:</span>{" "}
                      <span className="text-taawa-text font-medium">
                        {selectedService}
                      </span>
                    </p>
                    <p>
                      <span className="text-taawa-muted">Date:</span>{" "}
                      <span className="text-taawa-text font-medium">
                        {selectedDate ? format(selectedDate, "PPP") : ""}
                      </span>
                    </p>
                    <p>
                      <span className="text-taawa-muted">Time:</span>{" "}
                      <span className="text-taawa-text font-medium">
                        {selectedTime}
                      </span>
                    </p>
          ...
          {step === 5 && (
            <div className="text-center bg-white rounded-card p-10 max-w-lg mx-auto border border-taawa-lime/30 shadow-md">
              ...
              <h2 className="font-syne font-bold text-taawa-text text-xl mb-3">
                You're All Set!
              </h2>
              ...
              <p className="font-instrument text-taawa-muted text-[0.92rem] leading-relaxed mb-6">
                ...
                <strong className="text-taawa-text">
                  {selectedDate ? format(selectedDate, "PPP") : ""}
                </strong>{" "}
                at <strong className="text-taawa-text">{selectedTime}</strong>.
